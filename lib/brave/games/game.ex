defmodule Brave.Games.Game do
  ...
  def changeset(game, attrs) do
    game
    |> cast(attrs, [:game_id, :p1_uuid, :p2_uuid, :p1_name, :p2_name, :p1_card, :p2_card, :p1_points, :p2_points, :p1_winnings, :p2_winnings, :p1_cards, :p2_cards, :on_hold, :p1_general?, :p2_general?, :completed?])
